                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>{{ $info->title }}</td>
                                    <td>{{ $info->body }}</td>
                                    <td> <a target="_blank" href="{{ $info->link }}">الرابط</a></td>
                                    <td> <img src="{{ $info->image }}" width="100" height="100" alt=""></td>

                                    <td>
                                        <a href="#" data-toggle="modal" data-target="#edit_model" data-id = "{{$info->id}}" data-title = "{{$info->title}}" data-body = "{{$info->body}}" data-image = "{{$info->image}}"  data-link = "{{$info->link}}"  class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                        {{--                                            <a href="#" class="btn btn-info btn-sm disabled"><i class="fa fa-edit"></i> @lang('site.edit')</a>--}}
                                        {{-- <form action="{{ route('main_section.destroy', $info->id) }}" method="post" style="display: inline-block">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="was-validated" enctype="multipart/form-data" novalidate action="{{route('main_section.update','update')}}" method="post" id="#">
                                    {{csrf_field()}}
                                    @method('put')
                                    ...
                                    <div class="form-group">
                                        <label for="code">@lang('site.link')</label>
                                        <input type="url" name="link" class="form-control" value="{{old('link')}}" id="link">
                                        @error('link')
                                    ...
                                    <div class="form-group">
                                        <img src="{{ asset('uploads/user_images/default.png') }}" id="image"   style="width: 100px" class="img-thumbnail image-preview" alt="">
                                    </div>
                ...
                <div class="modal fade" id="create_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="was-validated" enctype="multipart/form-data" novalidate action="{{route('main_section.store')}}" method="post" id="#">
                                {{csrf_field()}}
                                @method('post')
