                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>{{ $info->body }}</td>
                                    <td>
                                        <a href="#" data-toggle="modal" data-target="#edit_model" data-id = "{{$info->id}}" data-title = "{{$info->title}}" data-body = "{{$info->body}}"  class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                        {{--                                            <a href="#" class="btn btn-info btn-sm disabled"><i class="fa fa-edit"></i> @lang('site.edit')</a>--}}
                                        <form action="{{ route('about_us.destroy', $info->id) }}" method="post" style="display: inline-block">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">@lang('site.edit') @lang('site.info')</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form  class="was-validated" enctype="multipart/form-data" novalidate action="{{route('about_us.update','update')}}" method="post" id="#">
                                    {{csrf_field()}}
                                    @method('put')
                ...
                <div class="modal fade" id="create_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="was-validated" enctype="multipart/form-data" novalidate action="{{route('about_us.store')}}" method="post" id="#">
                                {{csrf_field()}}
                                @method('post')
