                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('services.destroy', $info->id) }}" method="post" style="display: inline-block">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
                ...
                <div class="modal fade" id="create_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="was-validated" enctype="multipart/form-data" novalidate action="{{route('services.store')}}" method="post" id="#">
                                {{csrf_field()}}
                                @method('post')
