                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="was-validated" enctype="multipart/form-data" novalidate action="{{route('blogs.update','update')}}" method="post" id="#">
                                    {{csrf_field()}}
                                    @method('put')
                ...
                <div class="modal fade" id="create_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="was-validated" enctype="multipart/form-data" novalidate action="{{route('blogs.store')}}" method="post" id="#">
                                {{csrf_field()}}
                                @method('post')
